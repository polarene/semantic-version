    ...
    Given("two versions") {
        ...
        When("Major, Minor, and Patch are equal") {
            Then("normal versions have the same precedence") {
                Version(1) shouldBeEqualComparingTo Version(1)
            }
            ...
            // TODO comparison between pre-release versions
        }
    }
})
